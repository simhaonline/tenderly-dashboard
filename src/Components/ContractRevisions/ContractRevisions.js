...
class ContractRevisions extends Component {
    viewTransactionsForContract = (event, contract) => {
    ...
    render() {
        const {projectContract, currentContract, contracts, onListenToggle, onDelete} = this.props;
                    ...
                    return <Link key={revision.id} to={`${projectContract.getUrlForRevision(revision.id)}/revisions`} className="ContractRevisions__RevisionLink">
                        <Card clickable className={classNames("DisplayFlex AlignItemsCenter ContractRevisions__Revision", {
                            ...
                            <div className="MarginLeftAuto DisplayFlex AlignItemsCenter">
                                ...
                                <Button outline size="small" className="MarginLeft2" onClick={event => this.viewTransactionsForContract(event, contract)}>
                                    <Icon icon="box"/>
...
export default withRouter(ContractRevisions);
